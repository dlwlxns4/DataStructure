...
//using namespace std;
//
//void recursive(int n, int recursiveCount)
//{
//	if (n <= 0)
//	{
...
//			cout << "_";
//		}
//		cout << "\"재귀함수가 뭔가요?\"" << endl; for (int i = 0; i < recursiveCount * 4; ++i)
//		{
//			cout << "_";
//		}
//		cout << "\"재귀함수는 자기 자신을 호출하는 함수라네\"" << endl; for (int i = 0; i < recursiveCount * 4; ++i)
//		{
//			cout << "_";
//		}
//		cout << "라고 답변하였지." << endl;
